...
The tools are still in infancy to support native TDD. Culture spawned from the web world (where testing is simpler) have transitioned and can adversely impact delivery if taken at full speed.
...
Giving and receiving feedback is not natural, but without it teams and the individuals within cannot grow. The 1-on-1 gives a unique opportunity to get a certain level of honesty and feelings out in the open. Especially important in remote teams, but I would recommend regular 1-on-1's in all dev teams.
...
![Mobile Forum](http://i.imgur.com/GIzm6Iu.jpg)
